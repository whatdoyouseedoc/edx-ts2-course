define(["require", "exports", "./arrayUtils.js"], function (require, exports, arrayUtils_js_1) {
    "use strict";
    ...
    function callArrayUtil(util, array, array2) {
        ...
        document.getElementById('output').innerHTML = arrayUtils_js_1["default"][util](array1, array2).toString();
    }
